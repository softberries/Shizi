 ...
 This will deploy two artifacts, target/Shizi.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/Shizi.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/Shizi.war

 To undeploy the application, run:

  ./asadmin undeploy Shizi
